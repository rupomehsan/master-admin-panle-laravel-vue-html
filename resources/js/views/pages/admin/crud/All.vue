        ...
        <div class="pt-2">
            <div class="page-header">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">CRUD Management</h5>
                    </div>
                    ...
                    <div class="card-header align-items-center">
                        ...
                        <div class="btns d-flex gap-2 align-items-center">
                            <div class="table_actions">
                                <a href="#" class="btn px-3 btn-outline-secondary"><i class="fa fa-list"></i></a>
                                <ul>
                                    <li>
                                        <a href="">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="i in 10" :key="i">
                                    ...
                                    <td>43</td>
                                    <td><img src="/backend/assets/images/avatar.png" alt="Avatar" class="rounded-circle"
                        ...
                        <div class="d-inline-block">
                            <ul class="pagination pagination-sm">
                                ...
                                <li class="page-item pagination-next-nav ">
                                    <a href="#" aria-label="Next" class="page-link" tabindex="-1">
